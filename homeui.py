...
class Mainpage(qt.QWidget):
    def mainpage(self, encryptfile, decryptfile, parent: qt.QWidget, stack=QStackedWidget):
        ...
        #image
        picture = qt.QLabel()
        pixmap = QPixmap(resource_path("materials/pic.png"))
        if pixmap.isNull():
        ...
        enc_header_layout.setSpacing(5)
        iconenc = qt.QLabel()
        iconenc.setPixmap(QPixmap(resource_path("materials/encicon.png")).scaled(24, 24))
        ...
        iconbrowseenc.setIcon(QIcon(resource_path("materials/folder.png")))
        ...
        self.enc_toggle_btn.setIcon(QIcon(resource_path("materials/invisible.png")))
        ...
        dec_header_layout.setSpacing(5)
        icondec = qt.QLabel()
        icondec.setPixmap(QPixmap(resource_path("materials/decicon.png")).scaled(24, 24))
        ...
        iconbrowsedec.setIcon(QIcon(resource_path("materials/folder.png")))
        ...
        self.dec_toggle_btn.setIcon(QIcon(resource_path("materials/invisible.png")))
    ...
    def toggle_enc_password(self):
        if self.enc_toggle_btn.isChecked():
            ...
            self.enc_toggle_btn.setIcon(QIcon(resource_path("materials/visible.png")))
        else:
            self.enc_password.setEchoMode(QLineEdit.EchoMode.Password)
            self.enc_toggle_btn.setIcon(QIcon(resource_path("materials/invisible.png")))
    ...
    def toggle_dec_password(self):
        if self.dec_toggle_btn.isChecked():
            ...
            self.dec_toggle_btn.setIcon(QIcon(resource_path("materials/visible.png")))
        else:
            self.dec_password.setEchoMode(QLineEdit.EchoMode.Password)
            self.dec_toggle_btn.setIcon(QIcon(resource_path("materials/invisible.png")))
